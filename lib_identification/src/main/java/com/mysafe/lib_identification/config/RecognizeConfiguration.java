package com.mysafe.lib_identification.config;

import com.arcsoft.face.LivenessParam;

import static com.mysafe.lib_identification.config.DefaultConfig.DEFAULT_FACE_SIZE;
import static com.mysafe.lib_identification.config.DefaultConfig.DEFAULT_MAX_FACE;
...
public class RecognizeConfiguration {
    ...
    public static class Builder {
        ...
        private int extractRetryCount = 5;
        private int livenessRetryCount = 5;
        private int maxDetectFaces = DEFAULT_FACE_SIZE;
        //识别失败间隔时间
        ...
        //人脸图像质量
        private float imageQualityThreshold = 0.30f;
        private boolean enableLiveness = false;
        private boolean enableImageQuality = false;
        private boolean keepMaxFace = DEFAULT_MAX_FACE;
        private LivenessParam livenessParam;
