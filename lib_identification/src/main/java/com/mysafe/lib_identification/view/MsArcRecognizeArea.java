 ...
 * * <p>
 * * 结合{@link MsArcFaceRect}和{@link com.mysafe.lib_identification.camera.FaceRectHelper}使用，可判断人脸是否显示在镂空区域
 * * <p>
 * * 注意：需要保证人脸框绘制正确，识别区域的控制才有效。
 * * <p>
 * * 实际使用中建议不要实现onTouch
 */
public class MsArcRecognizeArea extends View {
    /**
     * 限制的识别区域
     */
     ...
     * 识别区域发生变更的回调
     */
    public interface IOnRecognizeAreaChangedListener {
        /**
         * 当识别区域发生变更时执行
         *
    ...
    IOnRecognizeAreaChangedListener onRecognizeAreaChangedListener;
     ...
     */
    public void SetOnRecognizeAreaChangedListener(IOnRecognizeAreaChangedListener onRecognizeAreaChangedListener) {
        this.onRecognizeAreaChangedListener = onRecognizeAreaChangedListener;
    }

    public MsArcRecognizeArea(Context context) {
        this(context, null);
    }

    public MsArcRecognizeArea(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
